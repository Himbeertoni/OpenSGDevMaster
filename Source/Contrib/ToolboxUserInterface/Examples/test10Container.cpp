...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of \\{\\color=AAAA00FF ComponentContainer}s, such as \\{\\color=AAAA00FF Panel} to hierarchically");
    DocForeground->addLine("arrange GUI components.");
