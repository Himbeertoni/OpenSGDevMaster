...
class SingleIncrementButtonListener1 : public ButtonSelectedListener // Single Increment Button Listener for Spinner 1
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the button is selected set Spinner1 to increment by 1
    {         
        TheModel1->setStepSize(1);

    }

    void buttonDeselected(const ButtonSelectedEventPtr e) // If the button is deselected set Spinner1 to increment by 2
    {
...
class SingleIncrementButtonListener2 : public ButtonSelectedListener // Single Increment Button Listener for Spinner 2
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the button is selected set Spinner2 to increment by 1
    {         
        TheModel2->setStepSize(3);

    }

    void buttonDeselected(const ButtonSelectedEventPtr e) // If the button is deselected set Spinner2 to increment by 2
    {
...
class SingleIncrementButtonListener3 : public ButtonSelectedListener // Single Increment Button Listener for Spinner 3
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the button is selected set Spinner3 to increment by 1
    {         
        TheModel3->setStepSize(5);

    }

    void buttonDeselected(const ButtonSelectedEventPtr e) // If the button is deselected set Spinner3 to increment by 2
    {
...
class DoubleIncrementButtonListener1 : public ButtonSelectedListener // Double Increment Button Listener for Spinner 1
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the button is selected set Spinner3 to increment by 2
    {         
        TheModel1->setStepSize(2);
    }

    void buttonDeselected(const ButtonSelectedEventPtr e) // If the button is deselected set Spinner3 to increment by 1
    {
        TheModel1->setStepSize(1);
    }
};
...
{
  public:
    void mouseClicked(const MouseEventPtr e)
    {
    }
    void mouseEntered(const MouseEventPtr e)
    {
    }
    void mouseExited(const MouseEventPtr e)
    {
    }
...
class MakeTorus : public ButtonSelectedListener // Button listener for Add Torus check button
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the check button is selected draw the torus
    {         
    ...
    void buttonDeselected(const ButtonSelectedEventPtr e) // If the check button is deselected remove the torus
    {         
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
...
class MakeSphere : public ButtonSelectedListener // Button listener for Add Sphere check button
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the check button is selected draw the sphere
    {         
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
    ...
    void buttonDeselected(const ButtonSelectedEventPtr e) // If the check button is deselected remove the sphere
    {
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
...
class MakeBox : public ButtonSelectedListener // Button listener for Add Box check button
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the check button is selected draw the box
    {         
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
    ...
    void buttonDeselected(const ButtonSelectedEventPtr e) // If the check button is deselected remove the box
    {
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
...
class MakeCone : public ButtonSelectedListener // Button listener for Add Cone check button
{
  public:
    ...
    void buttonSelected(const ButtonSelectedEventPtr e) // If the check button is selected draw the cone
    {         
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
    ...
    void buttonDeselected(const ButtonSelectedEventPtr e) // If the check button is deselected remove the cone
    {
        beginEditCP(scene, Node::CoreFieldMask | Node::ChildrenFieldMask);
