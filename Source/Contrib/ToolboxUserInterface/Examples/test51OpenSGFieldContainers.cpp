...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("This tutorial is an interface that presents detailed");
    DocForeground->addLine("information about specific FieldContainers of the");
    DocForeground->addLine("UserInterface library.");
