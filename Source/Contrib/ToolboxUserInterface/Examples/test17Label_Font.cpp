...
SimpleTextForegroundTransitPtr SimpleScreenDoc::makeDocForeground(void)
{
    ...
    DocForeground->addLine("of \\{\\color=AAAA00FF UIFont}. A \\{\\color=AAAA00FF List} and \\{\\color=AAAA00FF DefaultListComponentGenerator}");
    DocForeground->addLine("are used for presenting all of the available fonts");
    DocForeground->addLine("on the system.");
...
int main(int argc, char **argv)
{
...

    {
        ...
        SimpleSceneManagerRefPtr sceneManager = OSG::SimpleSceneManager::create();
