...
bool OSG_CONTRIBTOOLBOXANIMATION_DLLMAPPING getInterpolationIndexes(const MFReal32& Keys, const Real32& time, UInt32& LastKeyframeIndex, UInt32& NextKeyframeIndex, Real32& t, bool isCyclic=false);

bool OSG_CONTRIBTOOLBOXANIMATION_DLLMAPPING getInterpolationIndex(const MFReal32& Keys, const Real32& time, UInt32& Index, Real32& t, bool isCyclic=false);
...
std::string OSG_CONTRIBTOOLBOXANIMATION_DLLMAPPING lerp( const std::string& From, const std::string& To, Real32 t);
std::string OSG_CONTRIBTOOLBOXANIMATION_DLLMAPPING lerpFromSide( const std::string& From, const std::string& To, Real32 t);
std::string OSG_CONTRIBTOOLBOXANIMATION_DLLMAPPING lerpAll( const std::string& From, const std::string& To, Real32 t);
